    ...
    <div className='bg-black my-[-2px] relative pb-[46px] '>
      <div className='max-w-[1164px] px-3 mx-auto z-10'>
        <div className='relative'>
          <div className='Suscribe_BG_img max-w-[480px] backdrop-blur-md sm:max-w-[576px] md:max-w-[768px] lg:max-w-[900px] mx-auto w-full relative z-20 p-5 sm:p-[25px] md:p-[45px] flex items-center flex-col '>
            ...
            <div className='max-w-[489px] z-20 relative max-sm:max-w-[320px] border-[1px] mt-9 max-sm:mt-6 border-[#FFFFFF45] p-[6px] pl-[15px] flex w-full justify-between'>
              ...
              <div className=' max-w-[151px] z-20 relative w-full max-sm:hidden h-[47.19px] bg-btn_Border flex justify-center items-center  Btn_Body cursor-pointer duration-300 ease-linear hover:drop-shadow-[0px_0px_5px_red] custom_duration'>
                <h3 className='font-poppins font-normal text-base leading-[24px] text-white '>Submit Now</h3>
              </div>
            </div>
            <div className=' max-w-[151px] z-10 relative w-full sm:hidden mt-[15px] h-[47.19px] bg-btn_Border flex justify-center items-center Btn_Body cursor-pointer duration-300 ease-linear hover:drop-shadow-[0px_0px_5px_red] custom_duration'>
