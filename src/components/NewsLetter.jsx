        ...
        <div className='relative'>
          <div className='bg-suscribeBgImg bg-100%  bg-no-repeat bg-center  max-w-[480px] backdrop-blur-md sm:max-w-[576px] md:max-w-[768px] lg:max-w-[900px] mx-auto w-full relative z-20 p-5 sm:p-[25px] md:p-[45px] flex items-center flex-col '>
            ...
            <div className='max-w-[489px] z-20 relative max-sm:max-w-[320px] border-[1px] mt-9 max-sm:mt-6 border-[#FFFFFF45] p-[6px] pl-[15px] flex w-full justify-between'>
              ...
              <div className=' max-w-[151px] z-20 relative w-full max-sm:hidden h-[47.19px] bg-btn_Border flex justify-center items-center bg-cover bg-center bg-no-repeat bg-btnBody cursor-pointer duration-300 ease-linear hover:drop-shadow-[0px_0px_5px_red] custom_duration'>
                <a className='font-poppins font-normal text-base leading-[24px] text-white '>Submit Now</a>
              </div>
            </div>
            <div className=' max-w-[151px] z-10 relative w-full sm:hidden mt-[15px] h-[47.19px] bg-btn_Border flex justify-center items-center bg-cover bg-center bg-no-repeat bg-btnBody cursor-pointer duration-300 ease-linear hover:drop-shadow-[0px_0px_5px_red] custom_duration'>
