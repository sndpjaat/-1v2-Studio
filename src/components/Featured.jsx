...
const Featured = () => {
    ...
    return (
        <div className='featuredBgImg 2xl:bg-100% flex flex-col pb-[80px] sm:pb-[128px] relative md:pb-[168px] lg:pb-[175px] -mt-[2px]'>
            ...
            <div className=' feature_Slider pt-[89px] pb-[125px] max-sm:pt-12 max-md:pt-[60px] max-lg:pb-[90px] z-40  '>
                <Slider {...settings} className='h-full'>
                    <div className='fireplaceBgimg w-full max-w-[324px] p-5 flex flex-col max-sm:min-h-[400px] sm:min-h-[421px] md:min-h-[461px]'>
