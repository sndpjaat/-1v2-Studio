            ...
            <nav className='bg-white bg-opacity-[10%] flex  '>
                <div className="container mx-auto px-3 max-w-[1140px]">
                    ...
                    <img src={Nav_logo} alt="Nav_logo" />
                        ...
                        <button className=' onClick={() => setShow(!show)} text-white font-poppins font-medium text-[16px] leading-[24px] hover:shadow-btnshadow w-[151px] h-[47px] cursor-pointer duration-300 ease-linear hover:drop-shadow-[0px_0px_5px_red] Btn_Body'>Get Started</button>
            ...
            <div className='max-w-[1164px] px-3 mx-auto relative' id='1'>
                <div className="row">
                    <div className=' w-full md:w-6/12 px-3 pt-[144px]'>
                        ...
                        <div className='Btn_Body w-fit min-h-[24px] px-[32px] py-[12px] mt-[42px] cursor-pointer duration-300 ease-linear hover:drop-shadow-[0px_0px_5px_red]'>
