                    ...
                    <div className='flex py-[24px] justify-between '>
                        ...
                        <ul className={`${data ? "right-0" : "right-[-100%]"} flex items-center  justify -between z-[50] gap-[20px] max-lg:fixed top-0  max-lg:bg-[#0E0C0C]  max-lg:w-full max-lg:h-full max-xl:top-0  max-lg:flex-col max-lg:justify-center duration-500`}>
                            <li className=' relative group'>
                                ...
                                <a href="#1" onClick={() => setData(false)}  className='  text-white  opacity-70 hover:opacity-[100%] font-normal text-[16px]  duration-300  capitalize font-poppins'>home</a>
                            ...
                            <li className=' relative group'>
                                ...
                                <a href="#about" onClick={() => setData(false)} className='text-white  opacity-70 hover:opacity-[100%] font-normal text-[16px]  duration-300  capitalize font-poppins'>About Us</a>
                            ...
                            <li className='relative group'>
                                ...
                                <a href="#1" onClick={() => setData(false)}  className='text-white  opacity-70 hover:opacity-[100%] font-normal text-[16px]  duration-300  capitalize font-poppins'>Portfolio</a>
                            ...
                            <li className='relative group'>
                                ...
                                <a href="#1" onClick={() => setData(false)}  className='text-white  opacity-70 hover:opacity-[100%] font-normal text-[16px]  duration-300  capitalize font-poppins'>Services</a>
                            ...
                            <li className='relative group'>
                                ...
                                <a href="#1" onClick={() => setData(false)}  className='text-white  opacity-[70%] hover:opacity-[100%] font-normal text-[16px]  duration-300  capitalize font-poppins'>Testimonial</a>
                            ...
                            <li className='relative group'>
                                ...
                                <a href="#1" onClick={() => setData(false)}  className='text-white  opacity-70 hover:opacity-[100%] font-normal text-[16px]  duration-300  capitalize font-poppins'>Contact Us</a>
                            </li>
                        </ul>
                        <div className='flex items-center gap-[30px]'>
                            <button className=' onClick={() => setShow(!show)} text-white font-poppins font-medium text-[16px] leading-[24px] hover:shadow-btnshadow w-[151px] h-[47px] cursor-pointer duration-300 ease-linear hover:drop-shadow-[0px_0px_5px_red] bg-btnBody bg-cover bg-no-repeat bg-center'>Get Started</button>
